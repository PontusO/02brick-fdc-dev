...
;
    seg.u     zero_page
crc           ds  1   ; CRC lo byte  (two byte variable)
crch          ds  1   ; CRC hi byte  

ptr           ds  1   ; data pointer (two byte variable)
ptrh          ds  1   ;   "    "

blkno         ds  1   ; block number 
retry         ds  1   ; retry counter 
retry2        ds  1   ; 2nd counter
bflag         ds  1   ; block flag 
;
;
...
; V 1.1a Modified to skip the load address (PO)
