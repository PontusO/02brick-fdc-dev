...
;	------------------------------------------
;
a_maskuc      equ   %01011111 ;case conversion mask
a_hexnum      equ   "A"-"9"-1  ;hex to decimal difference
n_radix       equ   4          ;number of supported radixes
s_fac         equ   4          ;binary accumulator size
;
;================================================================================
;
;ZERO PAGE STORAGE
;
    seg.u     zero_page
ptr01         ds  2             ;input string pointer
stridx        ds  1             ;string index
pfac          ds  4             ;primary accumulator
sfac          ds  4             ;secondary accumulator
bitsdig       ds  1             ;bits per digit
curntnum      ds  1             ;numeral being processed
radxflag      ds  1             ;$80 = processing base-10
valdnum       ds  1             ;valid range +1 for selected radix
;
;	------------------------------------------------------
...
;
basetab:
        dc.b  10,2,8,16        ;number bases per radix
bitstab:
        dc.b  3,1,3,4          ;bits per digit per radix
radxtab:
        dc.b  " %@$"           ;valid radix symbols
